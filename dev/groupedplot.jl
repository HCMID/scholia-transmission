...
# ╔═╡ 97735122-e94b-11eb-1072-21d10c1154b3
begin
	using StatsPlots
	md"Test notebook"
end

# ╔═╡ e8d36eb7-b6a7-4b45-9df6-45c1829ccbf9
md"Stacked bar chart."

# ╔═╡ 6e29cb9e-14ec-4ed3-8966-1b484cae4c31
ms1 = [7, 5, 3]

# ╔═╡ f280adc8-ead3-4d7b-97ca-79a23a701cbd
ms2 = [1, 2, 1]

# ╔═╡ 11886dc3-ec32-4242-b232-f43d7d01f016
hcat(ms1)

# ╔═╡ 5cc72497-b9b8-4306-8a2c-71c61bf21835


# ╔═╡ a28e381e-87b4-4ff4-b487-185e1a695f5a
mspair = [ ms1 ms2 ]

# ╔═╡ 8d6b5a41-5a89-465a-b22b-fe249c980c1a
topic1 = mspair[1,:]

# ╔═╡ 445e91d8-0f16-4e77-bf40-166e9825c98d
topic2 = mspair[2,:]

# ╔═╡ c2b84fcb-579e-41de-a8e2-4a53074b80a8
topic3 = mspair[3,:]

# ╔═╡ be20deb3-92a4-46a4-a90d-abcfeaf44d2b
groupedbar([ topic1 topic2 topic3 ];   bar_position = :stack,)

# ╔═╡ b326f04b-ed99-4ad8-9efd-535abe0889d3
...
# ╔═╡ a027f4db-e380-4625-9d70-fe5fba1f711a
mx = vecvec_to_matrix([ms1, ms2])

# ╔═╡ 13075279-2dba-483c-95b7-cfe6accc700c
groupedbar(mx; bar_position = :stack)
