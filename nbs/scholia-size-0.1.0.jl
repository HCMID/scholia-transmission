...
> Include option to download counts as a delimited-text file.
"""
...
scholia = filter(cn -> occursin("comment", cn.urn.urn),  c.corpus)
...
# ╔═╡ d6849a9f-51ca-4a98-9ef9-9faa031ce619
begin
	delimited = join(sizes,"\n")
	md"- Download delimited file $(DownloadButton(delimited,\"scholialengths.cex\"))"
end
