...
using CSV, DataFrames, HTTP, Plots, PlutoUI, Unicode
...
# ╔═╡ 748aca1e-e316-4538-a000-393e7398a9ae
begin
	
	dldatalines = []
	for l in labels
		push!(dldatalines,Unicode.normalize(l; stripmark=true))
	end
	dldata = join(dldatalines,"\n")	
	md"Download list of $lmt terms $(DownloadButton(dldata, \"frequentwords.txt\"))"
end
